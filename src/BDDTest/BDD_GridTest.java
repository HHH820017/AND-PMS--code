...
public class BDD_GridTest {
    ...
    public static void main(String[] args) {
        ...
        int[][] componentsArr ={{1,2,3,4,5},{1,2,3,6},{1,2,3},{1,2,3},{7,8},{8,9},{8,9,10},{7,8,9,10},{11,12,13},{11,14},{11,15},{11,16}};
//        ,{3,5},{10, 11} ,1,2 ,2,2
        int[] kArr = {1, 2, 2, 2, 1, 1, 2, 3, 1, 1, 1, 2};
        int[] nArr = {5, 4, 3, 3, 2, 2, 3, 4, 3, 2, 2, 2};
