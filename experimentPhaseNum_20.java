package Reset.Experiment.CombineNum;
...
public class CombineNum_6 {
    ...
    public static void main(String[] args) {
        ...
        beforeCombineTreeTest.LabelLib.add("2/4");
...
//        System.out.println("阶段合并前系统失效概率为：" + countProbability.Tree_Result(beforeCombineTree.listPathOne, List2));
        ...
        afterCombineTree.combinePhase[2] = 0;
        afterCombineTree.combinePhase[3] = 0;
//        afterCombineTree.combinePhase[4] = 0;
//        afterCombineTree.combinePhase[5] = 0;
//        afterCombineTree.combinePhase[6] = 0;
//        afterCombineTree.combinePhase[7] = 0;
//        afterCombineTree.combinePhase[8] = 0;
//        afterCombineTree.combinePhase[9] = 0;
/*        for (int i = 0; i < afterCombineTree.combinePhase.length; i++) {
            System.out.print(afterCombineTree.combinePhase[i] +" ");
        }
        System.out.println();*/
        ...
        for (int i = 0; i < times; i++) {
            ...
            afterCombineTree = afterCombineTree.getAfterCombineTreeTest(afterCombineTree, beforeCombineTree);
